...
worksheet_2020.Range("A" + str(last_row_2020+1) + ":V" + str(last_row_2020+1)).PasteSpecial(Paste=-4163)

#Paste from second file, number of rows are added
worksheet_2020_mois.Range("A2:V" + str(last_row_2020_mois)).Copy()
worksheet_2020.Range("A" + str(last_row_2020+last_row_2021+1) + ":V" + str(last_row_2020+last_row_2021+1)).PasteSpecial(Paste=-4163)

#Paste from second file, number of rows are added
worksheet_2021_mois.Range("A2:V" + str(last_row_2021_mois)).Copy()
worksheet_2020.Range("A" + str(last_row_2020+last_row_2021+last_row_2020_mois+1) + ":V" + str(last_row_2020+last_row_2021+last_row_2020_mois+1)).PasteSpecial(Paste=-4163)
